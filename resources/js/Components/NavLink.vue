...
const classes = computed(() =>
    props.active
        ? 'inline-flex items-center px-1 pt-1 border-b-2 border-indigo-400  text-lg font-medium leading-5 text-blue-700  focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
